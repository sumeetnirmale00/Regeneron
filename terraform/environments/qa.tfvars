...
# =============================================================================
# Warehouses - REGN_GD_WH_QA_<PURPOSE>
# =============================================================================
warehouses = [
  {
    name              = "REGN_GD_WH_QA_ETL"
    size              = "X-SMALL"
    auto_suspend      = 120
    auto_resume       = true
    min_cluster_count = 1
    max_cluster_count = 1
    comment           = "Warehouse for environment QA with purpose for ETL jobs"
  },
  {
    name              = "REGN_GD_WH_QA_USR"
    size              = "SMALL"
    auto_suspend      = 300
    auto_resume       = true
    min_cluster_count = 1
    max_cluster_count = 2
    comment           = "Warehouse for environment QA with purpose for Data management users and analytics users"
  },
  {
    name              = "REGN_GD_WH_QA_REPORTING"
    size              = "X-SMALL"
    auto_suspend      = 60
    auto_resume       = true
    min_cluster_count = 1
    max_cluster_count = 1
    comment           = "Warehouse for environment QA with purpose for Reporting and other Tools"
  },
]
...
# DW: REGN_GD_WH_DEV is created manually
